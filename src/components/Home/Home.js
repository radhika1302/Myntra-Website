...
import av2 from '../images/avatar.png'
          ...
          <Fragment>
            <div className='mt-8 w-[100vw]' >
              ...
              <Carousel showThumbs={false} showStatus={false} showArrows={false} showIndicators={true} autoPlay={6000} infiniteLoop={true} renderIndicator={(onClickHandler, isSelected, index, label) => indicator(onClickHandler, isSelected, index, label)}>
                ...
                {/* <div>
                  <Link to='/products'><LazyLoadImage effect='blur' src={b3} width='80%' className='min-h-[320px]' alt='Banner_Image' /><br /></Link>
                  <div className='h-[50px]'>
                ...
                <div style={{ textAlign: 'left' }}>
                    <Link to='/products'>
                    <LazyLoadImage effect='blur' src={b3} width='100%' className='min-h-[320px]' alt='Banner_Image' /><br />
                     </Link>
                  <div className='h-[50px]'>
                    {/* Additional content */}
                   </div>
              ...
              <div className='grid grid-cols-8'>
                ...
                <Link to='/products'><LazyLoadImage effect='blur' src={av2} alt="" className="min-h-[200px]" /></Link>
            ...
            {/* <div style={{ textAlign: 'right' }}>
              <div className='grid grid-cols-8'>
                <Link to='/products'>
                  <LazyLoadImage effect='blur' src={av2} alt="" className="min-h-[200px]" />
                </Link>
              </div>
            </div> */}
    ...
    <div className="giftcontainer">
        <div className="gift">
           ...
           <label htmlFor="click" className="click"   ></label>
            <div className="wishes">Avatar created Successfully</div>
        </div>
    </div>
